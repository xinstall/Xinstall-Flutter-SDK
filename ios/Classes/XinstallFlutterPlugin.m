...
static NSString * const XinstallThirdVersionFlag = @"XINSTALL_THIRDSDKVERSION_1.5.1_THIRDSDKVERSION_XINSTALL";
static NSInteger const XinstallThirdPlatform = 8;
static NSString * const XinstallThirdVersion = @"1.5.1";
